...
namespace Mediapipe.Unity.Sample
{
  ...
  {
    private static RawImageSource _RawImageSource;
    ...
    public static ImageSourceType CurrentSourceType
    {
      get
      {
        if (ImageSource is RawImageSource)
        {
          return ImageSourceType.RawImage;
        }
    ...
    internal static void Initialize(RawImageSource rawImageSource, WebCamSource webCamSource, StaticImageSource staticImageSource, VideoSource videoSource)
    {
      _RawImageSource = rawImageSource;
    ...
    public static void Switch(ImageSourceType imageSourceType)
    {
      ...
      {
        case ImageSourceType.RawImage:
          {
            ImageSource = _RawImageSource;
            break;
          }
